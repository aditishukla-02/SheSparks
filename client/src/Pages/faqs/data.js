export const data = [
  ...
  },
  {
    ...
    answer: `S provides a platform to collect, publish and share aggregated data of reported sexual violence. Data is open source and is available for individuals, communities and institutions to take necessary action. There is a provision on the app which facilitates guidance to contact the local police/hospitals if needed. Legal process to file a report and IPC information is available in the Legal resources page. This platform does not replace or substitute what is required by law.`,
  },
  {
    question: `Why should I report on the SheSparks app?`,
    answer: `SheSparks is a crowdsourcing tool for incidents of sexual violence. It works best when we have substantial amounts of data in any given location or category. This data which is anonymous, gets aggregated as hot spots on a map indicating trends at a local level. This is an aid to prevent and to create a peaceful and safe environment for all.`,
  },
  {
